 ...
 * @author nikos
 */
public class MinEduΑacademicResponse implements Serializable {
    ...
    public MinEduΑacademicResponse() {
    }

    public MinEduΑacademicResponse(Result Result, String ServiceCallID, String code, boolean success, String timestamp) {
        this.Result = Result;
