 ...
 * @author nikos
 *
 * response from queuering for the academicid of the user from their amka number
 *
 */
public class MinEduAcadAmkaResponse {
    ...
    public MinEduAcadAmkaResponse() {
    }

    public MinEduAcadAmkaResponse(AmkaResult Result, String ServiceCallID, String code, boolean success, String timestamp) {
        this.Result = Result;
