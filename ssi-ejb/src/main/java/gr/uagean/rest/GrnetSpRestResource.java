...
@ApplicationScoped
public class GrnetSpRestResource {
    ...
    private final static Logger LOG = LoggerFactory.getLogger(GrnetSpRestResource.class);

    private MemcachedClient mcc;

    public GrnetSpRestResource(KeycloakSession session) {
     ...
     *
     */
    // https://dss1.aegean.gr/auth/realms/grnetEidas/broker/oidc/endpoint
    @GET
    ...
    public Response taxisCallback(
        ...
        String proceedWithAuthenticationUrl = this.propServ.getProp("GRNET_AUTH_PROCEED"); //https://dss1.aegean.gr/auth/realms/SSI/protocol/openid-connect/auth
