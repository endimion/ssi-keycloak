 ...
 * @author nikos
 */
public class BeforeSSIPersonalAuthenticator extends AbstractSSIAuthenticator {

//    protected ParameterService paramServ = new ParameterServiceImpl();
    private static final Logger LOG = LoggerFactory.getLogger(BeforeSSIPersonalAuthenticator.class);
