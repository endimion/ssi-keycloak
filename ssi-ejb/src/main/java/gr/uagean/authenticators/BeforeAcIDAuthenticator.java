 ...
 * @author nikos
 */
public class BeforeAcIDAuthenticator extends AbstractSSIAuthenticator {

//    protected ParameterService paramServ = new ParameterServiceImpl();
    private static final Logger LOG = LoggerFactory.getLogger(BeforeAcIDAuthenticator.class);
...
//            LOG.info("will add with key:" + state + " object " + ksTO.toString());
            ...
            Response challenge = context.form()
                    ...
                    .setAttribute("forward", this.propServ.getProp("POST_ACID_URI"))
                    .setAttribute("proceed", this.propServ.getProp("AFTER_ACID_URI"))
                    .createForm("acid.ftl");
