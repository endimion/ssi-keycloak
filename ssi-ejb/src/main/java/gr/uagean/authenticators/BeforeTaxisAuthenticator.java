...
//            RealmModel realm = context.getRealm();
            ...
            Response challenge = context.form()
                    .setAttribute("clientId", this.propServ.getProp("TAXIS_CLIENT_ID"))
                    .setAttribute("redirectURI", this.propServ.getProp("TAXIS_REDIRECT_URI"))
                    .setAttribute("authorizeURI", this.propServ.getProp("TAXIS_OAUTH2_URL_AUTHORIZE"))
